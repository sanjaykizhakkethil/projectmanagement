(function () {
    "use strict";
    if (localStorage.getItem("azeadarktheme")) {
    ...
    if (localStorage.azealayout) {
      let html = document.querySelector("html");
      html.setAttribute("data-nav-layout", "horizontal");
      document.querySelector("html").setAttribute("data-menu-styles", "light");
    }
    if (localStorage.getItem("azealayout") == "horizontal") {
      document
        .querySelector("html")
    ...
    function localStorageBackup() {
      ...
      if (localStorage.azeadarktheme) {
        let html = document.querySelector("html");
        html.setAttribute("data-theme-mode", "dark");
      }
      if (localStorage.azealayout) {
        let html = document.querySelector("html");
        let layoutValue = localStorage.getItem("azealayout");
        html.setAttribute("data-nav-layout", "horizontal");
        setTimeout(() => {
          clearNavDropdown();
        }, 5000);
      ...
      if (localStorage.azeaverticalstyles) {
        let html = document.querySelector("html");
        let verticalStyles = localStorage.getItem("azeaverticalstyles");
  
        if (verticalStyles == "default") {
          html.setAttribute("data-vertical-style", "default");
          localStorage.removeItem("azeanavstyles");
        }
          ...
          setTimeout(() => {
            ...
            menuSlideItem.forEach((e) => {
              ...
              e.addEventListener("mouseenter", () => {
                if (localStorage.azeaverticalstyles == "doublemenu") {
      ...
      if (localStorage.azeanavstyles) {
        let html = document.querySelector("html");
        let navStyles = localStorage.getItem("azeanavstyles");
        if (navStyles == "menu-click") {
          html.setAttribute("data-nav-style", "menu-click");
          localStorage.removeItem("azeaverticalstyles");
      ...
      if (localStorage.azeaclassic) {
        let html = document.querySelector("html");
        html.setAttribute("data-page-style", "classic");
      }
      if (localStorage.azeamodern) {
        let html = document.querySelector("html");
        html.setAttribute("data-page-style", "modern");
      }
      if (localStorage.azeaboxed) {
        let html = document.querySelector("html");
        html.setAttribute("data-width", "boxed");
      }
      if (localStorage.azeaheaderfixed) {
        let html = document.querySelector("html");
        html.setAttribute("data-header-position", "fixed");
      }
      if (localStorage.azeaheaderscrollable) {
        let html = document.querySelector("html");
        html.setAttribute("data-header-position", "scrollable");
      }
      if (localStorage.azeamenufixed) {
        let html = document.querySelector("html");
        html.setAttribute("data-menu-position", "fixed");
      }
      if (localStorage.azeamenuscrollable) {
        let html = document.querySelector("html");
        html.setAttribute("data-menu-position", "scrollable");
      }
      if (localStorage.azeaMenu) {
        let html = document.querySelector("html");
        let menuValue = localStorage.getItem("azeaMenu");
        switch (menuValue) {
          case "light":
      ...
      if (localStorage.azeaHeader) {
        let html = document.querySelector("html");
        let headerValue = localStorage.getItem("azeaHeader");
        switch (headerValue) {
          case "light":
