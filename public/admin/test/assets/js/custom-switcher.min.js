...
function switcherClick() {
    ...
    let colorMenuVar = colorMenuBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("azeaMenu", 'color');
    });
    /* Color Menu End */
    ...
    let gradientMenuVar = gradientMenuBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("azeaMenu", 'gradient');
    });
    /* Gradient Menu End */
    ...
    let transparentMenuVar = transparentMenuBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("azeaMenu", 'transparent');
    });
    ...
    let colorHeaderVar = colorHeaderBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("azeaHeader", 'color');
    });
    /* Color Header End */
    ...
    let gradientHeaderVar = gradientHeaderBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("azeaHeader", 'gradient');
    });
    /* Gradient Header End */
    ...
    let transparentHeaderVar = transparentHeaderBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("azeaHeader", 'transparent');
    });
    ...
    let fullwidthVar = fullwidthBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("azeafullwidth", true);
        localStorage.removeItem("azeaboxed");
    });
    ...
    let boxedVar = boxedBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("azeaboxed", true);
    ...
    let shadowVar = regular.addEventListener('click', () => {
        ...
        localStorage.setItem("azearegular", true);
        localStorage.removeItem("azeaclassic");
        localStorage.removeItem("azeamodern");
    });
    ...
    let noShadowVar = classic.addEventListener('click', () => {
        ...
        localStorage.setItem("azeaclassic", true);
        localStorage.removeItem("azearegular");
        localStorage.removeItem("azeamodern");
    });
    ...
    let modernVar = modern.addEventListener('click', () => {
        ...
        localStorage.setItem("azeamodern", true);
        localStorage.removeItem("azearegular");
        localStorage.removeItem("azeaclassic");
    });
    ...
    let fixedHeaderVar = fixedHeaderBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("azeaheaderfixed", true);
        localStorage.removeItem("azeaheaderscrollable");
    });

    let scrollHeaderVar = scrollHeaderBtn.addEventListener('click', () => {
        html.setAttribute('data-header-position', 'scrollable');
        localStorage.setItem("azeaheaderscrollable", true);
        localStorage.removeItem("azeaheaderfixed");
    });
    ...
    let fixedMenuVar = fixedMenuBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("azeamenufixed", true);
        localStorage.removeItem("azeamenuscrollable");
    });

    let scrollMenuVar = scrollMenuBtn.addEventListener('click', () => {
        html.setAttribute('data-menu-position', 'scrollable');
        localStorage.setItem("azeamenuscrollable", true);
        localStorage.removeItem("azeamenufixed");
    });
    ...
    let closedVar = closedBtn.addEventListener('click', () => {
        closedSidemenuFn();
        localStorage.setItem("azeaverticalstyles", 'closed');
    });
    /* Closed Sidemenu End */
    ...
    let detachedVar = detachedBtn.addEventListener('click', () => {
        detachedFn();
        localStorage.setItem("azeaverticalstyles", 'detached');
    });
    /* Hover Submenu End */
    ...
    let iconTextVar = iconTextBtn.addEventListener('click', () => {
        iconTextFn();
        localStorage.setItem("azeaverticalstyles", 'icontext');
    });
    ...
    let overlayVar = overlayBtn.addEventListener('click', () => {
        iconOverayFn();
        localStorage.setItem("azeaverticalstyles", 'overlay');
    });
    ...
    let doubleVar = doubleBtn.addEventListener('click', () => {
        doubletFn();
        localStorage.setItem("azeaverticalstyles", 'doublemenu');
    });
    ...
    let menuClickVar = menuClickBtn.addEventListener('click', () => {
        ...
        menuClickFn();
        localStorage.setItem("azeanavstyles", 'menu-click');
        localStorage.removeItem("azeaverticalstyles");
    ...
    let menuhoverVar = menuHoverBtn.addEventListener('click', () => {
        html.removeAttribute('data-vertical-style');
        menuhoverFn();
        localStorage.setItem("azeanavstyles", 'menu-hover');
        localStorage.removeItem("azeaverticalstyles");
    ...
    let iconClickVar = iconClickBtn.addEventListener('click', () => {
        html.removeAttribute('data-vertical-style');
        iconClickFn();
        localStorage.setItem("azeanavstyles", 'icon-click');
        localStorage.removeItem("azeaverticalstyles");
    ...
    let iconhoverVar = iconHoverBtn.addEventListener('click', () => {
        html.removeAttribute('data-vertical-style');
        iconHoverFn();
        localStorage.setItem("azeanavstyles", 'icon-hover');
        localStorage.removeItem("azeaverticalstyles");
    ...
    let verticalVar = verticalBtn.addEventListener('click', () => {
        ...
        // local storage
        localStorage.removeItem("azealayout");
        localStorage.setItem("azeaverticalstyles", 'default');
        verticalFn();
        setNavActive();
    ...
    let horiVar = horiBtn.addEventListener('click', () => {
        ...
        html.removeAttribute('data-vertical-style');
        //    local storage
        localStorage.setItem("azealayout", 'horizontal');
        localStorage.removeItem("azeaverticalstyles");
...
function lightFn() {
    ...
    html.setAttribute('data-header-styles', 'light');
    html.setAttribute('data-menu-styles', 'light');
    // html.removeAttribute('data-menu-styles', 'dark');
    ...
    localStorage.removeItem("azeabgColor");
    localStorage.removeItem("azeaheaderbg");
    localStorage.removeItem("azeabgwhite");
    localStorage.removeItem("azeamenubg");
    localStorage.removeItem("azeamenubg");
    checkOptions();
...
function horizontalClickFn() {
    ...
    if(!localStorage.azeaMenu && !localStorage.bodylightRGB){
        html.setAttribute("data-menu-styles","light")
        document.querySelector('#switcher-menu-light').checked = true;
        checkOptions();
    }
...
function checkOptions() {
    ...
    // light header
    if (localStorage.getItem('azeaHeader') === "light") {
        document.querySelector('#switcher-header-light').checked = true;
    }

    // color header
    if (localStorage.getItem('azeaHeader') === "color") {
        document.querySelector('#switcher-header-primary').checked = true;
    }

    // gradient header
    if (localStorage.getItem('azeaHeader') === "gradient") {
        document.querySelector('#switcher-header-gradient').checked = true;
    }

    // dark header
    if (localStorage.getItem('azeaHeader') === "dark") {
        document.querySelector('#switcher-header-dark').checked = true;
    }
    // transparent header
    if (localStorage.getItem('azeaHeader') === "transparent") {
        document.querySelector('#switcher-header-transparent').checked = true;
    }

    // light menu
    if (localStorage.getItem('azeaMenu') === 'light') {
        document.querySelector('#switcher-menu-light').checked = true;
    }

    // color menu
    if (localStorage.getItem('azeaMenu') === 'color') {
        document.querySelector('#switcher-menu-primary').checked = true;
    }

    // gradient menu
    if (localStorage.getItem('azeaMenu') === 'gradient') {
        document.querySelector('#switcher-menu-gradient').checked = true;
    }

    // dark menu
    if (localStorage.getItem('azeaMenu') === 'dark') {
        document.querySelector('#switcher-menu-dark').checked = true;
    }
    // transparent menu
    if (localStorage.getItem('azeaMenu') === 'transparent') {
        document.querySelector('#switcher-menu-transparent').checked = true;
    }

    //boxed
    if (localStorage.getItem('azeaboxed')) {
        document.querySelector('#switcher-boxed').checked = true;
    }

    //scrollable
    if (localStorage.getItem('azeaheaderscrollable')) {
        document.querySelector('#switcher-header-scroll').checked = true;
    }
    if (localStorage.getItem('azeamenuscrollable')) {
        document.querySelector('#switcher-menu-scroll').checked = true;
    }

    //fixed
    if (localStorage.getItem('azeaheaderfixed')) {
        document.querySelector('#switcher-header-fixed').checked = true;
    }
    if (localStorage.getItem('azeamenufixed')) {
        document.querySelector('#switcher-menu-fixed').checked = true;
    }

    //classic
    if (localStorage.getItem('azeaclassic')) {
        document.querySelector('#switcher-classic').checked = true;
    }

    //modern
    if (localStorage.getItem('azeamodern')) {
