...
function switcherClick() {
    ...
    let lightThemeVar = lightBtn.addEventListener('click', () => {
        lightFn();
        localStorage.setItem("azeaHeader", 'light');
        localStorage.setItem("azeaMenu", 'light');
    })
    /* Light Layout End */
    ...
    let darkThemeVar = darkBtn.addEventListener('click', () => {
        darkFn();
        localStorage.setItem("azeaMenu", 'dark');
        localStorage.setItem("azeaHeader", 'dark');
    });
    /* Dark Layout End */
...
function lightFn() {
    ...
    updateColors()
    localStorage.removeItem("azeadarktheme");
    checkOptions();
    html.style.removeProperty('--primary-rgb');
}
...
function darkFn() {
    ...
    updateColors()
    localStorage.setItem("azeadarktheme", true);
    localStorage.removeItem("azealighttheme");
    checkOptions();
    html.style.removeProperty("--primary-rgb");
}
